...
void HAL::wrtMicroseconds(uint8_t servo,int ms, uint16_t autoOff) {
    Com::printFLN(PSTR("Spindle Speed Servo = "), servo);
    Com::printFLN(PSTR("Spindle Speed ms = "), ms);
    servoTimings[servo] = ms;
    servoAutoOff[servo] = autoOff;
}
